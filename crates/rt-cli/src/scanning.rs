...
use rt_signatures::matching::results::ScanFinding;
use rt_timeline::findings::FindingRow;
...
mod tests {
    ...
    use rt_signatures::engines::sigma::SigmaEngine;
    ...
    fn test_finding_to_row_conversion() {
        let finding = ScanFinding {
            source: rt_signatures::matching::results::MatchSource::Sigma,
            severity: rt_signatures::matching::results::Severity::High,
...
"#,
    ...
    fn test_scan_phase_file_hash_match() {
        ...
        let sha256 = rt_signatures::engines::ioc_hash::sha256_hex(data);
