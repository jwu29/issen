...
consequences. We named Parser Independence as an architectural principle -- parsers
operating on byte sequences compose uniformly with all five primitives
(Proposition~\ref{thm:parser-indep}) -- and derived from it a layer-dependency
rule that constrains how forensic software is organized
(Proposition~\ref{thm:layer-rule}); we
