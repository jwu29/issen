...
Issen fully implements \src{P}, \src{M}, \src{L}, and \src{Q} (VQL via
\texttt{velociraptor-parser}). The \src{C} crates (\texttt{git-forensic},
\texttt{sigstore-forensic}, \texttt{cas-forensic}) are in active development;
Case~2 marks prospective elements explicitly.
