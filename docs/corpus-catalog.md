...
[`~/src/ronin-issen/docs/test-data-catalog.md`](../../ronin-issen/docs/test-data-catalog.md).**
...
This redirect keeps the ~40 fleet repos that relative-link `issen/docs/test-data-catalog.md`
